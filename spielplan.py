...
Fassung 5:
  - Nach jedem Spiel werden Datum und Uhrzeit wieder vergessen. Findet
    sich fuer ein Spiel keine eigene Datumszeile, wird es verworfen statt
    das Datum des vorherigen Spiels zu erben. Genau dieser Fehler hatte
    in Fassung 4 alle Spiele auf den 14.09.2026 gelegt.
  - Der Vereinsspielplan wird zuerst ueber ajax.club.matchplan abgefragt.
    Dort stehen Datum und Uhrzeit als Text. Die Druckansicht kommt nur
    noch hinterher, weil ihr die Datumsangaben fehlen.
  - Eine Warnung meldet, wenn auffaellig viele Spiele auf denselben Tag
    fallen. So faellt ein Datumsfehler kuenftig sofort auf.
